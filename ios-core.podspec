...
Pod::Spec.new do |s|
  ...
  s.source_files  = 'iOSCore/*.{h,m}', 'iOSCore/Classes/**/*.{h,m}'
  #s.exclude_files = "Classes/Exclude"

  #s.public_header_files = "PSMiOSCore/**/*.h"
  ...
  #s.vendored_framework = 'Pods/NewRelicAgent/NewRelicAgent/NewRelicAgent.framework'
